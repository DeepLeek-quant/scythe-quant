...
class SinoPacAccount(sj.Shioaji):
    def __init__(self, key: dict = None, sim: bool = False):
        ...
        key = key or config.sinopac_config
...
class FubonAccount():
    def __init__(self, key:dict=None):
        ...
        key = key or config.fubon_config
...
class FubonTrader:
    def __init__(self, api: FubonAccount):
        self.api = api
                

class PortfolioManager(SinoPacTrader):
    """投資組合管理執行類別
    ...
    def sync(self):
        ...
        inventory_positions = self.list_inventories()
    ...
    def from_json(self, path: str=None):
        ...
        inventory = self.list_inventories()
